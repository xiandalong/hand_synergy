...
% Left Hand
csv_path = 'S:\Xianda\Dropbox\Data and docs\optiTrackData\Session 2014-11-20\cylinder_a1.csv';
marker_set_LeftHand = 'LeftHand';
palm_marker_index_LeftHand = 26:34;
finger_marker_index_LeftHand =reshape(1:25,5,5)';
b1_b2_index_LeftHand =[32,28];
b3_cmc4_index_LeftHand =[33,26];
joint_angles_LeftHand = getJointAngles(csv_path_LeftHand,marker_set_LeftHand,...
...
joint_angles_RightHand = getJointAngles(csv_path_RightHand,marker_set_RightHand,...
