...
%  palm_marker_index: 1 X N vector containing indice for markers on the palm
%  finger_marker_index: 5 X N matrix containing indices of markers on each
%    finger, each row start with the most distal marker
%  b1_b2_index: index of marker on b1&b2 (check the layout in "Marker
%    description.doc"
