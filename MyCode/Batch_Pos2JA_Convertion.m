...
% save_dir = 'C:\Users\kelvi_000\OneDrive\Haptics research\hand_synergy\MyCode\Data_Subject1.mat';
...
save_dir = 'C:\Users\kelvi_000\OneDrive\Haptics research\hand_synergy\MyCode\Data_Subject2.mat';
...
% save_dir = 'C:\Users\kelvi_000\OneDrive\Haptics research\hand_synergy\MyCode\Data_Subject3.mat';
...
% save_dir = 'C:\Users\kelvi_000\OneDrive\Haptics research\hand_synergy\MyCode\Data_Subject4.mat';
...
for j=1:num_trials
    ...
    moving_speed_LeftHand = calcMovingSpeed(marker_pos_LeftHand,wrist_marker_index,frame_rate);
    ...
    joint_angles_RightHand = getJointAngles(marker_pos_RightHand,...
        palm_marker_index,finger_marker_index,b1_b2_index,b3_cmc4_index);
    moving_speed_RightHand = calcMovingSpeed(marker_pos_RightHand,wrist_marker_index,frame_rate);
...
%     %
    ...
    Data_table.moving_speed_LeftHand{j} = moving_speed_LeftHand;
    Data_table.moving_speed_RightHand{j} = moving_speed_RightHand;
    
    Data_table.GA_LeftHand{j} = GA_LeftHand;
    Data_table.GA_RightHand{j} = GA_RightHand;
end

% save the "data_table" in a mat file
save(save_dir,'Data_table');
...
%%%%%%%%%%%%%%%%%%%%%%%% VERSION 2 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%% taking in an epoch in the holding phase, and output the downsampled
%%%%% frames %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
